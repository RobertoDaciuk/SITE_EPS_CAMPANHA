    ...
    >
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Configure multiplicadores de prêmios para períodos específicos da campanha
          </p>
        </div>
      </div>
      ...
      <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-lg p-4 flex items-start gap-3">
        ...
        <div className="text-sm space-y-2">
          <p className="font-semibold text-yellow-600 dark:text-yellow-400">💡 Como Funcionam os Eventos Multiplicadores</p>
          
          <div className="text-muted-foreground space-y-1.5">
            <p>
              <strong>• Período de Envio:</strong> Apenas pedidos <strong>ENVIADOS</strong> durante o período do evento receberão o multiplicador.
            </p>
            <p>
              <strong>• Validação Posterior:</strong> É <strong>PERMITIDO</strong> que esses pedidos sejam validados após o evento finalizar.
            </p>
            <p className="italic bg-yellow-500/5 rounded p-2 border-l-2 border-yellow-500">
              ...
              → Um pedido enviado em 18/01 pode ser validado em 25/01 (após o evento) e ainda receberá 2x nos pontos.
            </p>
            <p>
              <strong>• Visibilidade:</strong> Vendedores verão apenas eventos ATIVOS (dentro do período) com design destacado.
            </p>
          </div>
        </div>
      </div>
