...
export default function PreviewCampanha({ state, currentStep }: PreviewCampanhaProps) {
                    ...
                    <div className="flex items-center gap-4 mt-1 text-xs text-gray-600">
                      ...
                      {requisito.produtos && requisito.produtos.length > 0 && (
                        <span className="flex items-center gap-1">
                          ...
                          {requisito.produtos.length} produto(s)
                        </span>
                      )}
                    </div>
                  </div>
  ...
  // ========================================
  // PREVIEW DOS PRODUTOS (Sprint 21: REMOVIDO)
  // ========================================
  // Produtos agora são configurados por requisito, não globalmente.
  // O preview de produtos está disponível em cada card de requisito no Step3Cartelas.
